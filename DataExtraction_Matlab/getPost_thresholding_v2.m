...
function [] =  getPost_thresholding_v2(iPt)
...
for n = 1:N 
    ...
    segment_length = 5*60 + sz_lengths(n);            % sec, Length of time to record
    fprintf('\nSegment length = %d\n', segment_length)
...
% visualization. Look again tho
    ...
    threshold = [4000 3500 4000 2000 10000 10000 10000 2500 8000 4000 3000 10000 3000 2000 1000]                            % arbitrary from eyballing data                                      % arbitrary from eyballing data
