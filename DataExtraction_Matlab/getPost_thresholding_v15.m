...
function export =  getPost_thresholding_v15(iPt)
%% Options and parameters
tic
% Parameters
sz_to_use = 1;             % number os seizures to use in this analysis (takes the first found)
...
export = [R_sz_lengths(1), post_lengths(1)];
toc
