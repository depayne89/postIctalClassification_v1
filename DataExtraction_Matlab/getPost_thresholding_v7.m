...
function [] =  getPost_thresholding_v7(iPt)
...
sz_len_threshold = 40;  % s, cut-off between long and short seizures, determined by eye
...
%% Plot individual seizures
    ...
    if plot_all_on_one
        ...
        if sz_end< sz_len_threhsold                 % display plots in different colors based on time threshold
