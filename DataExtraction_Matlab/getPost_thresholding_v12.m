...
% Parameters
sz_to_use = 20;         % number os seizures to use in this analysis (takes the first found)
...
split_scatter = true;      % plot scatters for short and long seizures separately as well
